...
import androidGrfVidPr from '../fabric/AndroidVideoViewNativeComponent';
...
export default class RnVideo extends BaseComponent<RnVideoProps> {
  private labelLog = '[RnVideo]';
  static displayName = 'RnVideo';
  ...
  constructor(props: RnVideoProps) {
    super(props);
    let labelLogLocal = '';
    if (__DEV__) {
  ...
  render() {
    ...
    return (
      <Video
        ...
        ref={(ref) => this.refMethod(ref as (RnVideo & NativeMethods) | null)}
      />
    );
  }
}
