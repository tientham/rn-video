...
export interface ThreeSecPlayerRnVideoProps {
  source?: string;
  isPlay?: boolean;
  volume?: number;
  playerWidth?: number;
...
export default class ThreeSecPlayerRnVideo extends BaseComponent<ThreeSecPlayerRnVideoProps> {
  private labelLog = '[ThreeSecPlayerRnVideo]';
  static displayName = 'ThreeSecPlayerRnVideo';
  ...
  constructor(props: ThreeSecPlayerRnVideoProps) {
    super(props);
    let labelLogLocal = '';
    if (__DEV__) {
  ...
  render() {
    ...
    return (
      <Video
        ...
        ref={(ref) =>
          this.refMethod(ref as (ThreeSecPlayerRnVideo & NativeMethods) | null)
        }
      />
    );
  }
